-- Copa APDES 2026
-- Actualización de simulación: consola tipo carga real + cuenta regresiva.
-- Ejecutar UNA VEZ en Neon SQL Editor.
-- No borra ni modifica resultados reales de copa_matches/copa_match_events.
...
-- Reglas defensivas sin depender del nombre automático de constraints anteriores.
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
